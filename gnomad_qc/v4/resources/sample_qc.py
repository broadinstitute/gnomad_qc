...
def _get_ancestry_pca_ht_path(
    ...
    """
    return f"gs://fc-secure-b25d1307-7763-48b8-8045-fcae9caadfa1/tmp/genetic_ancestry_inference/v4_code/gnomad.{data_type}.v{version}.pca_{part}{'_with_unreleasable_samples' if include_unreleasable_samples else ''}.ht"
