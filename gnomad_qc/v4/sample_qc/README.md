...
flowchart TB;
  ...
  resource_ped_mendel_errors("<a href='https://github.com/broadinstitute/gnomad_qc/tree/main/gnomad_qc/v4/resources/sample_qc.py#L966'>ped_mendel_errors</a>"):::resource_color;  resource_get_joint_qc --> step_prepare_cuking_inputs;
...
flowchart TB;
  ...
  resource_pc_relate_pca_scores("<a href='https://github.com/broadinstitute/gnomad_qc/tree/main/gnomad_qc/v4/resources/sample_qc.py#L455'>pc_relate_pca_scores</a>"):::resource_color;  resource_get_joint_qc --> step_prepare_cuking_inputs;
  step_prepare_cuking_inputs --> resource_get_cuking_input_path;
  resource_get_cuking_input_path --> step_print_cuking_command;
...
flowchart TB;
  ...
  resource_nearest_neighbors("<a href='https://github.com/broadinstitute/gnomad_qc/tree/main/gnomad_qc/v4/resources/sample_qc.py#L820'>nearest_neighbors</a>"):::resource_color;
  step_apply_nearest_neighbor_filters["--apply-nearest-neighbor-filters"]:::step_color;  resource_get_sample_qc --> step_apply_regressed_filters;
  resource_ancestry_pca_scores --> step_apply_regressed_filters;
  resource_get_pop_ht --> step_apply_regressed_filters;
  resource_platform --> step_apply_regressed_filters;
  resource_joint_qc_meta --> step_apply_regressed_filters;
...
flowchart TB;
  ...
  resource_ped_mendel_errors("<a href='https://github.com/broadinstitute/gnomad_qc/tree/main/gnomad_qc/v4/resources/sample_qc.py#L966'>ped_mendel_errors</a>"):::resource_color;  step_compute_related_samples_to_drop --> resource_sample_rankings;
  resource_sample_rankings --> step_identify_duplicates;
  step_identify_duplicates --> resource_duplicates;
  resource_duplicates --> step_infer_families;
