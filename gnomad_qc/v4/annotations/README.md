...
flowchart TB;
  ...
  step_generate_sib_stats["generate_variant_qc_annotations.py --generate-sib-stats"]:::step_color;
  resource_get_sib_stats("<a href='https://github.com/broadinstitute/gnomad_qc/tree/main/gnomad_qc/v4/resources/annotations.py#L131'>get_sib_stats</a>"):::resource_color;
  step_export_info_vcf["generate_variant_qc_annotations.py --export-info-vcf"]:::step_color;
  step_export_split_info_vcf["generate_variant_qc_annotations.py --export-split-info-vcf"]:::step_color;
  step_run_vep["generate_variant_qc_annotations.py --run-vep"]:::step_color;
  resource_get_vep("<a href='https://github.com/broadinstitute/gnomad_qc/tree/main/gnomad_qc/v4/resources/annotations.py#L69'>get_vep</a>"):::resource_color;
  step_validate_vep["generate_variant_qc_annotations.py --validate-vep"]:::step_color;
  ...
  step_write_split_vds_and_downsampling_ht["generate_freq.py --write-split-vds-and-downsampling-ht"]:::step_color;
  resource_get_split_vds("<a href='https://github.com/broadinstitute/gnomad_qc/tree/main/gnomad_qc/v4/resources/annotations.py#L476'>get_split_vds</a>"):::resource_color;
  step_run_freq_and_dense_annotations["generate_freq.py --run-freq-and-dense-annotations"]:::step_color;
  ...
  step_combine_freq_hts["generate_freq.py --combine-freq-hts"]:::step_color;
  ...
  step_correct_for_high_ab_hets["generate_freq.py --correct-for-high-ab-hets"]:::step_color;
  resource_freq("<a href=''>freq</a>"):::resource_color;
  step_finalize_freq_ht["generate_freq.py --finalize-freq-ht"]:::step_color;
  step_get_duplicated_to_exomes["generate_freq_genomes.py --get-duplicated-to-exomes"]:::step_color;
  step_update_annotations["generate_freq_genomes.py --update-annotations"]:::step_color;
  resource_hgdp_tgp_meta_updated("<a href=''>hgdp_tgp_meta_updated</a>"):::resource_color;
  step_get_callstats_for_updated_samples["generate_freq_genomes.py --get-callstats-for-updated-samples"]:::step_color;
  resource_hgdp_tgp_updated_callstats("<a href='https://github.com/broadinstitute/gnomad_qc/tree/main/gnomad_qc/v4/resources/annotations.py#L441'>hgdp_tgp_updated_callstats</a>"):::resource_color;
  step_join_callstats_for_update["generate_freq_genomes.py --join-callstats-for-update"]:::step_color;
  step_compute_allele_number_for_new_variants["generate_freq_genomes.py --compute-allele-number-for-new-variants"]:::step_color;
  step_update_release_callstats["generate_freq_genomes.py --update-release-callstats"]:::step_color;
  step_compute_allele_number_for_pop_diff["generate_freq_genomes.py --compute-allele-number-for-pop-diff"]:::step_color;
  ...
  resource_get_info --> step_export_info_vcf;
  resource_get_info --> step_export_split_info_vcf;
  step_run_vep --> resource_get_vep;
  resource_get_vep --> step_validate_vep;
  step_finalize_ped --> resource_pedigree;
  resource_pedigree --> step_generate_trio_stats;
  step_finalize_relatedness_ht --> resource_relatedness;
  resource_relatedness --> step_generate_sib_stats;
  step_write_split_vds_and_downsampling_ht --> resource_get_split_vds;
  ...
  step_combine_freq_hts --> resource_get_freq;
  resource_get_freq --> step_correct_for_high_ab_hets;
  step_correct_for_high_ab_hets --> resource_freq;
  resource_freq --> step_finalize_freq_ht;
  ...
  step_get_callstats_for_updated_samples --> resource_hgdp_tgp_updated_callstats;
  resource_hgdp_tgp_updated_callstats --> step_join_callstats_for_update;
  resource_hgdp_tgp_meta_updated --> step_compute_allele_number_for_new_variants;
  step_join_callstats_for_update --> resource_hgdp_tgp_updated_callstats;
  resource_hgdp_tgp_updated_callstats --> step_compute_allele_number_for_new_variants;
  resource_hgdp_tgp_meta_updated --> step_update_release_callstats;
  resource_hgdp_tgp_updated_callstats --> step_update_release_callstats;
  step_compute_allele_number_for_new_variants --> resource_hgdp_tgp_updated_callstats;
  step_compute_allele_number_for_pop_diff --> resource_hgdp_tgp_updated_callstats;
  resource_hgdp_tgp_meta_updated --> step_apply_patch_to_freq_ht;
  step_update_release_callstats --> resource_hgdp_tgp_updated_callstats;
  resource_hgdp_tgp_updated_callstats --> step_apply_patch_to_freq_ht;
  resource_hgdp_tgp_meta_updated --> step_compute_allele_number_for_pop_diff;
  resource_hgdp_tgp_updated_callstats --> step_compute_allele_number_for_pop_diff;
...
flowchart TB;
  ...
  func_split_info --> resource_get_info;
  resource_get_info --> step_create_variant_qc_annotation_ht;
  ...
  func_run_generate_trio_stats --> resource_get_trio_stats;
  resource_get_trio_stats --> step_create_variant_qc_annotation_ht;
  step_generate_sib_stats --> resource_get_sib_stats;
  resource_get_sib_stats --> step_create_variant_qc_annotation_ht;
  resource_get_info --> step_export_info_vcf;
...
flowchart TB;
  ...
  resource_get_downsampling("<a href='https://github.com/broadinstitute/gnomad_qc/tree/main/gnomad_qc/v4/resources/annotations.py#L262'>get_downsampling</a>"):::resource_color;
  step_combine_freq_hts["--combine-freq-hts"]:::step_color;
  func_combine_freq_hts[["<a href='https://github.com/broadinstitute/gnomad_qc/tree/main/gnomad_qc/v4/annotations/generate_freq.py#L667'>combine_freq_hts</a>"]]:::func_color;
  func_update_non_ukb_freq_ht[["<a href='https://github.com/broadinstitute/gnomad_qc/tree/main/gnomad_qc/v4/annotations/generate_freq.py#L570'>update_non_ukb_freq_ht</a>"]]:::func_color;
  resource_get_freq("<a href='https://github.com/broadinstitute/gnomad_qc/tree/main/gnomad_qc/v4/resources/annotations.py#L284'>get_freq</a>"):::resource_color;
  step_correct_for_high_ab_hets["--correct-for-high-ab-hets"]:::step_color;
  func_correct_for_high_ab_hets[["<a href='https://github.com/broadinstitute/gnomad_qc/tree/main/gnomad_qc/v4/annotations/generate_freq.py#L754'>correct_for_high_ab_hets</a>"]]:::func_color;
  func_generate_faf_grpmax[["<a href='https://github.com/broadinstitute/gnomad_qc/tree/main/gnomad_qc/v4/annotations/generate_freq.py#L815'>generate_faf_grpmax</a>"]]:::func_color;
  ...
  func_get_downsampling_ht --> resource_get_downsampling;
  resource_get_downsampling --> step_run_freq_and_dense_annotations;
  step_combine_freq_hts --> func_combine_freq_hts;
  func_combine_freq_hts --> func_update_non_ukb_freq_ht;
  func_update_non_ukb_freq_ht --> resource_get_freq;
  resource_get_freq --> step_correct_for_high_ab_hets;
  step_correct_for_high_ab_hets --> func_correct_for_high_ab_hets;
  func_correct_for_high_ab_hets --> func_generate_faf_grpmax;
  func_generate_faf_grpmax --> func_compute_inbreeding_coeff;
  func_compute_inbreeding_coeff --> resource_freq;
  resource_freq --> step_finalize_freq_ht;
  step_finalize_freq_ht --> func_create_final_freq_ht;
```
...
flowchart TB;
  ...
  func_filter_freq_arrays --> resource_hgdp_tgp_updated_callstats;
  resource_hgdp_tgp_updated_callstats --> step_join_callstats_for_update;
  ...
  func_join_release_ht_with_subsets --> resource_hgdp_tgp_updated_callstats;
  resource_hgdp_tgp_updated_callstats --> step_compute_allele_number_for_new_variants;
  resource_hgdp_tgp_meta_updated --> step_update_release_callstats;
  ...
  resource_hgdp_tgp_updated_callstats --> step_update_release_callstats;
  func_compute_an_by_group_membership --> resource_hgdp_tgp_updated_callstats;
  ...
  func_get_pop_diff_v3_vds_group_membership --> resource_hgdp_tgp_updated_callstats;
  resource_hgdp_tgp_meta_updated --> step_apply_patch_to_freq_ht;
  ...
  func_finalize_v4_genomes_callstats --> resource_hgdp_tgp_updated_callstats;
  resource_hgdp_tgp_updated_callstats --> step_apply_patch_to_freq_ht;
  resource_hgdp_tgp_meta_updated --> step_compute_allele_number_for_pop_diff;
  resource_hgdp_tgp_updated_callstats --> step_compute_allele_number_for_pop_diff;
```
