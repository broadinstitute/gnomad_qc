...
def add_updated_sample_qc_annotations(ht: hl.Table) -> hl.Table:
    ...
    # TODO: Need to change `gnomad_labeled_subpop` based on the hgdp_tgp_meta.population changes
...
def get_v4_genomes_release_resources(
    ...
    get_callstats_for_updated_samples = PipelineStepResourceCollection(
        ...
        output_resources={
            ...
            "freq_subtracted_ht": hgdp_tgp_updated_callstats(test=test, subset="subtracted"),
            "freq_pop_diff_ht": hgdp_tgp_updated_callstats(test=test, subset="pop_diff"),
        },
    )
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--update-release-callstats", help="", action="store_true"
    )
