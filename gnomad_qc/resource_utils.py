...
def get_default_private_resource_source() -> Union[GnomadPrivateResourceSource, str]:
    ...
    if default_source_from_env:
        ...
        try:
            ...
            logger.info(
                "Using configured source for gnomAD private resources: %s", default_source.value
            )
...
def set_gnomad_test():
    gnomad_private_resource_configuration.source = GnomadPrivateResourceSource.GNOMAD_PRODUCTION_TEMP
...
class GnomadPrivateTableResource(
    TableResource, GnomadPrivateResource, read_resource_methods=("ht",)
):
...
class GnomadPrivateMatrixTableResource(
    MatrixTableResource, GnomadPrivateResource, read_resource_methods=("mt",)
):
...
class GnomadPrivatePedigreeResource(
    PedigreeResource, GnomadPrivateResource, read_resource_methods=("ht", "pedigree")
):
...
class GnomadPrivateBlockMatrixResource(
    BlockMatrixResource, GnomadPrivateResource, read_resource_methods=("bm",)
):
...
class GnomadPrivateVariantDatasetResource(
    VariantDatasetResource, GnomadPrivateResource, read_resource_methods=("bm",)
):
    """Resource class for a private Hail VariantDataset generated by gnomAD production."""

    def vds(self, force_import: bool = False, test: bool = False) -> hl.vds.VariantDataset:
        """
