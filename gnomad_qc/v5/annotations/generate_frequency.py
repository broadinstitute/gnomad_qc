...
def _calculate_consent_frequencies(vmt: hl.MatrixTable, test: bool = False) -> hl.Table:
    ...
    # Ensure freq_meta is available for downstream merging (agg_by_strata
    # should have created this)
...
def _calculate_aou_variant_frequencies(
    ...
    # Log the freq_meta to ensure it's properly generated by agg_by_strata
    logger.info(
