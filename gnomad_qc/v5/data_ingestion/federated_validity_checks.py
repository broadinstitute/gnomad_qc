...
if __name__ == "__main__":
    ...
    parser.add_argument(
        ...
        help=(
            ...
            "corresponding to each frequency metadata group; freq_meta: Name of annotation containting allele frequency metadata, an ordered list containing the frequency aggregation group for "
            ...
            ")"
            "faf_fields: Dictionary containing the names of filtering allele frequency (FAF) related fields (faf: Name of annotation containing structs of filtering allele frequency information; faf_meta: Name of annotation "
