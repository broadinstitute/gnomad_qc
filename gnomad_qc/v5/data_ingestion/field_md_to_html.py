"""Script to convert required fields markdown to html. Note: run 'python field_md_to_html.py' after any edits to 'field_requiremnts.md' to kepp 'field_requirements.html' in sync."""
