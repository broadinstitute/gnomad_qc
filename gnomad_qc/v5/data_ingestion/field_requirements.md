...
| <span style="color:#999;">info.vrs</span>.VRS_Lengths | `array<str>` | The length values from ReferenceLengthExpression states for the GA4GH VRS Alleles corresponding to the GT indexes of the reference and alternate alleles. | `["T","C"]` | Optional |
