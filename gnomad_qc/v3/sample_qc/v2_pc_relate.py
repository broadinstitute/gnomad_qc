...
from gnomad_qc.v3.resources import gnomad_v2_qc_sites, v3_qc, meta, SAMPLE_QC_ROOT
import hail as hl
import argparse
...
def main(args):
    ...
    if args.run_pc_relate:
        ...
        scores = scores.checkpoint(f"{SAMPLE_QC_ROOT}/gnomad__v2_v3_release_pca_scores.ht", overwrite=args.overwrite, _read_if_exists=not args.overwrite)
        ...
        relatedness_ht.write(f"{SAMPLE_QC_ROOT}/gnomad__v2_v3_release_relatedness.ht", args.overwrite)
