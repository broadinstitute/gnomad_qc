...
def main(args):  # noqa: D103
    ...
    if args.export_coverage:
        ...
        if (
            "count_array" in ht.row_value
        ):  # Note that count_array isn't computed any more, so this is v3.0-specific
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--export_coverage", help="Exports coverage TSV file", action="store_true"
    )
    parser.add_argument(
        "--coverage_version",
        help=(
