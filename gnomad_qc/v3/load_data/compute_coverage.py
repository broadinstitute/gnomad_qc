...
def main(args):
    ...
    if args.compute_coverage_ht:
        ...
        coverage_ht.write(coverage('genomes').versions['3.0.1'].path, overwrite=args.overwrite)

    if args.export_coverage:
        ht = coverage('genomes').versions['3.0.1'].ht()
        ...
        ht.export(coverage_tsv_path('genomes', '3.0.1'))
